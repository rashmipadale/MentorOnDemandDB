...
INSERT INTO `users` (`id`, `active`, `confirm_code`, `email`, `name`, `password`, `username`) VALUES
	(1, b'1', '336MWL', 'linkedin@test.com', 'sunil', '$2a$10$Hkd2nOlCszEVi7IDo6w9weTB1iLmyHkIaOh7N5GwjNdH2DcCPXQ3i', 'test12323232'),
	(2, b'1', 'Z80AV6', 'naina.dangayach@gmail.com', 'sunil', '$2a$10$w6z35utJTcXXQTZ7hqSVkOAKBlzOk1bawACfIN8an.JNwEwBEg/9W', 'nainadangayach');
